...
# SHA-384 constants (first 64 bits of the fractional parts of the cube roots
...
(defn digest
  ...
  ```
  [input]
  # Initialize hash values (SHA-384 uses 8 64-bit words)
  ...
  (var h0 (ops/bjoin 0xcbbb9d5d 0xc1059ed8))
  (var h1 (ops/bjoin 0x629a292a 0x367cd507))
  (var h2 (ops/bjoin 0x9159015a 0x3070dd17))
  (var h3 (ops/bjoin 0x152fecd8 0xf70e5939))
  (var h4 (ops/bjoin 0x67332667 0xffc00b31))
  (var h5 (ops/bjoin 0x8eb44a87 0x68581511))
  (var h6 (ops/bjoin 0xdb0c2e0d 0x64f98fa7))
  (var h7 (ops/bjoin 0x47b5481d 0xbefa4fa4))
  ...
  # Input length as bits (SHA2-384 uses 128-bit length field)
