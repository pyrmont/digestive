...
(deftest original
  ...
  (def actual2 (sha2/digest-512 "The quick brown fox jumps over the lazy dog"))
  ...
  (is (== expect2 actual2))
  # Test "The quick brown fox jumps over the lazy dog."
  (def actual3 (sha2/digest-512 "The quick brown fox jumps over the lazy dog."))
  ...
  (is (== expect3 actual3))
  # Test "hello"
  (def actual4 (sha2/digest-512 "hello"))
...
(deftest fips-180-2
  ...
  (is (== expect1 actual1))
  # Test "abc"
  (def actual2 (sha2/digest-512 "abc"))
  ...
  (def actual3 (sha2/digest-512 "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq"))
...
(deftest standard-vectors
  # Test "message digest"
  (def actual1 (sha2/digest-512 "message digest"))
  ...
  (def actual2 (sha2/digest-512 "abcdefghijklmnopqrstuvwxyz"))
  ...
  (is (== expect2 actual2))
  # Test alphanumeric
  (def actual3 (sha2/digest-512 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"))
  ...
  (is (== expect3 actual3))
  # Test numbers
  (def actual4 (sha2/digest-512 "12345678901234567890123456789012345678901234567890123456789012345678901234567890"))
...
(deftest multi-block
  ...
  (def actual1 (sha2/digest-512 input1))
  ...
  (def actual2 (sha2/digest-512 input2))
...
(deftest boundary-cases
  ...
  (is (== expect1 actual1))
  # Test single byte
  (def actual2 (sha2/digest-512 "\x00"))
  ...
  (def actual3 (sha2/digest-512 input3))
  ...
  (def actual4 (sha2/digest-512 input4))
  ...
  (def actual5 (sha2/digest-512 input5))
