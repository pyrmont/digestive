...
(deftest multi-block
  ...
  (def actual1 (sha3/digest :256 input1))
...
(deftest boundary-cases
  ...
  (def actual3 (sha3/digest :256 input3))
  ...
  (def actual4 (sha3/digest :256 input4))
  ...
  (def actual5 (sha3/digest :256 input5))
  ...
  (def actual6 (sha3/digest :256 input6))
