...
(deftest standard-vectors
  # Test "message digest"
  (def actual1 (sha2-384/digest "message digest"))
  ...
  (def actual2 (sha2-384/digest "abcdefghijklmnopqrstuvwxyz"))
  (def expect2 "feb67349df3db6f5924815d6c3dc133f091809213731fe5c7b5f4999e463479ff2877f5f2936fa63bb43784b12f3ebb4")
  (is (== expect2 actual2))
  # Test alphanumeric
  (def actual3 (sha2-384/digest "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"))
  (def expect3 "1761336e3f7cbfe51deb137f026f89e01a448e3b1fafa64039c1464ee8732f11a5341a6f41e0c202294736ed64db1a84")
  (is (== expect3 actual3))
  # Test numbers
  (def actual4 (sha2-384/digest "12345678901234567890123456789012345678901234567890123456789012345678901234567890"))
...
(deftest multi-block
  ...
  (def actual1 (sha2-384/digest input1))
  ...
  (def actual2 (sha2-384/digest input2))
...
(deftest boundary-cases
  ...
  (def actual3 (sha2-384/digest input3))
  ...
  (def actual4 (sha2-384/digest input4))
  ...
  (def actual5 (sha2-384/digest input5))
