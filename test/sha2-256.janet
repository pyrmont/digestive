...
(deftest multi-block
  ...
  (def actual1 (sha2-256/digest input1))
...
(deftest boundary-cases
  ...
  (def actual3 (sha2-256/digest input3))
  ...
  (def actual4 (sha2-256/digest input4))
  ...
  (def actual5 (sha2-256/digest input5))
