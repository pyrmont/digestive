...
(import ../lib/blake3-256 :as blake3-256)

(deftest original
  # Test empty string
  (def actual1 (blake3-256/digest ""))
  (def expect1 "af1349b9f5f9a1a6a0404dea36dcc9499bcb25c9adc112b7cc9a93cae41f3262")
  (is (== expect1 actual1))
  # Test "The quick brown fox jumps over the lazy dog"
  (def actual2 (blake3-256/digest "The quick brown fox jumps over the lazy dog"))
  (def expect2 "2f1514181aadccd913abd94cfa592701a5686ab23f8df1dff1b74710febc6d4a")
  (is (== expect2 actual2))
  # Test "The quick brown fox jumps over the lazy dog."
  (def actual3 (blake3-256/digest "The quick brown fox jumps over the lazy dog."))
  (def expect3 "4c9bd68d7f0baa2e167cef98295eb1ec99a3ec8f0656b33dbae943b387f31d5d")
  (is (== expect3 actual3))
  # Test "hello"
  (def actual4 (blake3-256/digest "hello"))
...
(deftest multi-chunk
  ...
  (def actual1 (blake3-256/digest input1))
...
(deftest boundary-cases
  ...
  (def actual3 (blake3-256/digest input3))
  ...
  (def actual4 (blake3-256/digest input4))
  ...
  (def actual5 (blake3-256/digest input5))
  ...
  (def actual6 (blake3-256/digest input6))
