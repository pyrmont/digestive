...
(import ../lib/sha512 :as sha512)

(deftest digest
  # Test empty string
  (def actual1 (sha512/digest ""))
  ...
  (def actual2 (sha512/digest "The quick brown fox jumps over the lazy dog"))
  ...
  (is (== expect2 actual2))
  # Test "The quick brown fox jumps over the lazy dog."
  (def actual3 (sha512/digest "The quick brown fox jumps over the lazy dog."))
  ...
  (is (== expect3 actual3))
  # Test "hello"
  (def actual4 (sha512/digest "hello"))
